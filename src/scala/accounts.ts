export const scalaRelatedOrganizationProfiles = [
    ...
    "did:plc:cbicwmnsngxpzvehrpx2n6ul", // sbt            https://bsky.social/xrpc/com.atproto.identity.resolveHandle?handle=scala-sbt.org
    "did:plc:ul7a7ytwartrnbqmzdhczi4i", // Scala Days     https://bsky.social/xrpc/com.atproto.identity.resolveHandle?handle=scaladays.org
    "did:plc:orcrlhmf37rucjy7brakhkxk", // Scalar         https://bsky.social/xrpc/com.atproto.identity.resolveHandle?handle=scalar-conf.com
]
